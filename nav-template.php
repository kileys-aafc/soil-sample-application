...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="/index.php"><img class="" src="/images/soil-white.png" width="30" height="30" alt="">
            Home</a>
        ...
        <div class="navbar-collapse collapse" id="navbarsExampleDefault" style="">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/scan/scan-sample.php"><i class="fas fa-qrcode pr-2"
						style="font-size: 100%"></i>Scan Sample</a>
                </li>
				<li class="nav-item">
