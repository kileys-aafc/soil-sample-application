	...
	<div class="container">
		<div class="row mb-5">
			<div class="card-deck">
				...
				<div class="card">
				<i class="far fa-question-circle bg-secondary text-center text-light py-4" style="font-size: 800%"></i>
					<div class="card-body">
			...
			<div class="card-deck">
				...
				<i class="fas fa-edit bg-secondary text-center text-light py-4" style="font-size: 800%"></i>
					<div class="card-body">
						...
						<p class="card-text">Update sample, location, or project data currently within the archive database</p>
						<p><a class="btn btn-secondary" href="/update/update-data.php" role="button">View details</a></p>
					</div>
				</div>
				<div class="card">
				<i class="far fa-question-circle bg-secondary text-center text-light py-4" style="font-size: 800%"></i>
